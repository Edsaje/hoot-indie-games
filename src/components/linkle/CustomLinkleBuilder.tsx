...
const DEFAULT_CATEGORIES: CategoryDraft[] = [
  {
    ...
    difficulty: 1,
    items: [
      { id: 'stardew-valley', name: 'Stardew Valley', coverUrl: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=400&q=80' },
      { id: 'undertale', name: 'Undertale', coverUrl: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=400&q=80' },
      { id: 'axiom-verge', name: 'Axiom Verge', coverUrl: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&w=400&q=80' },
      { id: 'animal-well', name: 'Animal Well', coverUrl: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?auto=format&fit=crop&w=400&q=80' },
    ],
  },
  {
    ...
    difficulty: 2,
    items: [
      { id: 'celeste', name: 'Celeste', coverUrl: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=400&q=80' },
      { id: 'chicory', name: 'Chicory: A Colorful Tale', coverUrl: 'https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?auto=format&fit=crop&w=400&q=80' },
      { id: 'earthblade', name: 'Earthblade', coverUrl: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=400&q=80' },
      { id: 'moonglow-bay', name: 'Moonglow Bay', coverUrl: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=400&q=80' },
    ],
  },
  {
    ...
    difficulty: 3,
    items: [
      { id: 'outer-wilds', name: 'Outer Wilds', coverUrl: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=400&q=80' },
      { id: 'twelve-minutes', name: 'Twelve Minutes', coverUrl: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=400&q=80' },
      { id: 'loop-hero', name: 'Loop Hero', coverUrl: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=400&q=80' },
      { id: 'the-forgotten-city', name: 'The Forgotten City', coverUrl: 'https://images.unsplash.com/photo-1534447677768-be436bb09401?auto=format&fit=crop&w=400&q=80' },
    ],
  },
  {
    ...
    difficulty: 4,
    items: [
      { id: 'crow-country', name: 'Crow Country', coverUrl: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=400&q=80' },
      { id: 'signalis', name: 'Signalis', coverUrl: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?auto=format&fit=crop&w=400&q=80' },
      { id: 'iron-lung', name: 'Iron Lung', coverUrl: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=400&q=80' },
      { id: 'faith', name: 'FAITH: The Unholy Trinity', coverUrl: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?auto=format&fit=crop&w=400&q=80' },
    ],
  },
];
  ...
  const buildPuzzleObject = (): DailyConnectionsPuzzle => {
    const formattedCategories: ConnectionCategory[] = categories.map((cat, idx) => ({
      ...
      items: cat.items.map((item, itemIdx) => ({
        ...
        imageUrl: item.coverUrl || 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&w=400&q=80',
      })),
    }));
      ...
      <div className="relative w-full max-w-3xl bg-[#0e1422] border border-[#1e293b] rounded-2xl shadow-2xl p-6 overflow-hidden flex flex-col max-h-[90vh]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 id="custom-linkle-title" className="text-xl font-black text-white flex items-center gap-2">
                {currentLang === 'fr' ? 'Créateur de Linkle Personnalisé' : 'Custom Linkle Puzzle Crafter'}
              </h2>
              <p className="text-xs text-slate-400">
                {currentLang === 'fr'
                  ? 'Créez vos 4 groupes secrets de 4 jeux et partagez votre défi avec la communauté !'
                  : 'Design your 4 secret groups of 4 indie games and share with the community!'}
              </p>
            </div>
          </div>
          <button
              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs uppercase font-bold tracking-wider">
                    {currentLang === 'fr'
                      ? `Groupe ${catIdx + 1} (Niveau ${cat.difficulty})`
                      : `Group ${catIdx + 1} (Tier ${cat.difficulty})`}
                  </span>
                </div>
              </div>
        ...
        <div className="pt-4 border-t border-[#1e293b] flex flex-wrap items-center justify-between gap-3">
          <div className="text-xs text-slate-400 flex items-center gap-1.5">
            ...
            <span>
              {currentLang === 'fr'
                ? 'Les 16 tuiles seront automatiquement mélangées pour le joueur.'
                : 'All 16 tiles are dynamically shuffled when loaded by any player.'}
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {currentLang === 'fr' ? 'Tester maintenant' : 'Test Puzzle Now'}
            </button>
            ...
            >
              {copied ? (
                <>
                  ...
                  <span>{currentLang === 'fr' ? 'Lien copié ! 🪶' : 'Link Copied! 🪶'}</span>
                </>
              ) : (
                <>
                  <Share2 className="w-4 h-4" />
                  <span>{currentLang === 'fr' ? 'Générer & Copier le Lien' : 'Generate & Copy Link'}</span>
                </>
              )}
            </button>
          </div>
