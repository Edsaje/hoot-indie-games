...
const CURATED_OSTS: CuratedOST[] = [
  ...
  },
  {
    ...
    melody: [
      { note: 'F#', octave: 4, duration: 0.5 },
      { note: 'A', octave: 4, duration: 0.5 },
      { note: 'C#', octave: 5, duration: 0.7 },
      { note: 'E', octave: 5, duration: 0.9 },
      { note: 'C#', octave: 5, duration: 0.5 },
      { note: 'B', octave: 4, duration: 0.6 },
      { note: 'G#', octave: 4, duration: 0.8 },
      ...
      { note: 'E', octave: 5, duration: 0.6 },
      { note: 'C#', octave: 5, duration: 0.6 },
      { note: 'B', octave: 4, duration: 0.8 },
      { note: 'A', octave: 4, duration: 0.8 },
      { note: 'F#', octave: 4, duration: 2.0 },
    ],
  },
  {
    gameId: 'katana-zero',
    trackTitle: 'Sneaky Driver',
    ...
    melody: [
      ...
      { note: 'F', octave: 4, duration: 0.5 },
      { note: 'G', octave: 4, duration: 0.7 },
      { note: 'A', octave: 4, duration: 0.9 },
      { note: 'F', octave: 4, duration: 0.6 },
      { note: 'E', octave: 4, duration: 0.6 },
      { note: 'D', octave: 4, duration: 0.8 },
      { note: 'C#', octave: 4, duration: 0.8 },
      { note: 'D', octave: 4, duration: 2.4 },
    ],
  },
  {
    gameId: 'the-binding-of-isaac-rebirth',
    trackTitle: 'Sacrificial',
    composer: 'Ridiculon',
    instrument: 'piano',
    bpm: 94,
    melody: [
      ...
      { note: 'B', octave: 4, duration: 0.6 },
      { note: 'G', octave: 4, duration: 0.6 },
      { note: 'Eb', octave: 4, duration: 0.8 },
      { note: 'D', octave: 4, duration: 0.9 },
      { note: 'C', octave: 4, duration: 0.6 },
      { note: 'Eb', octave: 4, duration: 0.5 },
      { note: 'Ab', octave: 4, duration: 0.8 },
      { note: 'G', octave: 4, duration: 1.0 },
      { note: 'F', octave: 4, duration: 0.6 },
      { note: 'Eb', octave: 4, duration: 0.6 },
      { note: 'D', octave: 4, duration: 0.8 },
      { note: 'B', octave: 3, duration: 1.0 },
      { note: 'C', octave: 4, duration: 0.8 },
      { note: 'G', octave: 4, duration: 0.8 },
      { note: 'Eb', octave: 5, duration: 1.0 },
      { note: 'D', octave: 5, duration: 0.8 },
      { note: 'C', octave: 5, duration: 1.2 },
      { note: 'G', octave: 4, duration: 1.0 },
      { note: 'C', octave: 4, duration: 2.2 },
    ],
  },
  {
    gameId: 'hyper-light-drifter',
    trackTitle: 'Vignette: Panacea',
    composer: 'Disasterpeace',
    instrument: 'synth',
    bpm: 82,
    melody: [
      ...
      { note: 'G', octave: 4, duration: 0.7 },
      { note: 'B', octave: 4, duration: 0.9 },
      { note: 'E', octave: 5, duration: 1.2 },
      { note: 'D', octave: 5, duration: 0.7 },
      { note: 'B', octave: 4, duration: 0.7 },
      { note: 'A', octave: 4, duration: 0.9 },
      { note: 'G', octave: 4, duration: 1.1 },
      { note: 'C', octave: 4, duration: 0.8 },
      { note: 'E', octave: 4, duration: 0.7 },
      { note: 'G', octave: 4, duration: 0.9 },
      { note: 'C', octave: 5, duration: 1.2 },
      { note: 'B', octave: 4, duration: 0.8 },
      { note: 'A', octave: 4, duration: 0.7 },
      { note: 'F#', octave: 4, duration: 1.0 },
      ...
      { note: 'E', octave: 4, duration: 1.0 },
      { note: 'B', octave: 4, duration: 1.0 },
      { note: 'E', octave: 5, duration: 1.5 },
      { note: 'D#', octave: 5, duration: 1.2 },
      { note: 'E', octave: 5, duration: 2.4 },
    ],
  },
  {
    gameId: 'terraria',
    trackTitle: 'Overworld Day',
    ...
    melody: [
      ...
      { note: 'G', octave: 4, duration: 0.4 },
      { note: 'C', octave: 5, duration: 0.6 },
      { note: 'D', octave: 5, duration: 0.35 },
      { note: 'C', octave: 5, duration: 0.35 },
      { note: 'B', octave: 4, duration: 0.4 },
      { note: 'A', octave: 4, duration: 0.6 },
      { note: 'G', octave: 4, duration: 0.4 },
      { note: 'A', octave: 4, duration: 0.4 },
...
function createSoundtrackForGame(game: Game): {
  ...
  if (curated) {
    return {
      ...
      audioUrl: `/audio/blindtest/${curated.gameId}.mp3`,
      audioConfig: {
