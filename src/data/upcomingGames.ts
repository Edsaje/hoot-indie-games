...
export const UPCOMING_INDIE_GAMES: UpcomingGame[] = [
  {
    ...
    genres: [
      { fr: 'RPG / Simulation', en: 'RPG / Simulation' },
      { fr: 'Pixel Art', en: 'Pixel Art' },
      { fr: 'Aventure', en: 'Adventure' },
    ],
    platforms: ['PC', 'Consoles'],
    steamUrl: 'https://store.steampowered.com/app/2210520/Haunted_Chocolatier/',
    description: {
    ...
    hypeScore: 98,
    coverUrl: 'https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2210520/header.jpg',
  },
  {
    id: 'no-rest-for-the-wicked',
    title: 'No Rest for the Wicked (Version 1.0)',
    developer: 'Moon Studios',
    publisher: 'Private Division',
    expectedDate: {
      fr: 'Mars 2027 (Sortie 1.0)',
      en: 'March 2027 (1.0 Launch)',
    },
    genres: [
      { fr: 'Action-RPG', en: 'Action-RPG' },
      { fr: 'Soulslike', en: 'Soulslike' },
      { fr: 'Dark Fantasy', en: 'Dark Fantasy' },
    ],
    platforms: ['PC', 'PlayStation 5', 'Xbox Series X/S'],
    steamUrl: 'https://store.steampowered.com/app/1371980/No_Rest_for_the_Wicked/',
    description: {
      fr: 'Par les créateurs d\'Ori and the Blind Forest. Un Action-RPG isométrique mature et viscéral avec des combats au millimètre, une direction artistique peinte à la main et une narration captivante.',
      en: 'From Moon Studios (Ori series). A visceral, mature isometric Action-RPG featuring precision combat, breathtaking painterly visuals, and deep environmental storytelling.',
    },
    highlight: {
      fr: 'Sortie officielle de la version 1.0 concluant la campagne avec de nouvelles régions et du multijoueur.',
      en: 'Official 1.0 milestone concluding the full story campaign with new biomes and expanded multiplayer.',
    },
    hypeScore: 96,
    coverUrl: 'https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1371980/header.jpg',
  },
  {
    id: 'crowsworn',
    title: 'Crowsworn',
    ...
    genres: [
      ...
      { fr: 'Action Sombre', en: 'Dark Action' },
      { fr: 'Platformer 2D', en: '2D Platformer' },
    ],
    platforms: ['PC', 'Consoles'],
  ...
  },
  {
    ...
    genres: [
      { fr: 'Survie / Sandbox', en: 'Survival / Sandbox' },
      { fr: 'Monde Ouvert', en: 'Open World' },
      { fr: 'Aventure Coop', en: 'Co-op Adventure' },
    ],
    platforms: ['PC'],
  ...
  },
  {
    ...
    genres: [
      { fr: 'Plateforme 2D', en: '2D Platformer' },
      { fr: 'Aventure', en: 'Adventure' },
      { fr: 'Animation Traditionnelle', en: 'Traditional Animation' },
    ],
  ...
  },
  {
    ...
    genres: [
      { fr: 'Simulation de Vie', en: 'Life Sim' },
      { fr: 'École de Magie', en: 'Magic School' },
      { fr: 'Pixel Art Isométrique', en: 'Isometric Pixel Art' },
    ],
    platforms: ['PC', 'Consoles'],
  ...
  },
  {
    ...
    genres: [
      { fr: 'Puzzle Platformer 5D', en: '5D Puzzle Platformer' },
      { fr: 'Hybride 2D / 3D', en: '2D / 3D Hybrid' },
    ],
    platforms: ['PC', 'Consoles'],
  ...
  },
  {
    ...
    genres: [
      { fr: 'Ferme & Enquête', en: 'Farming & Mystery' },
      { fr: 'Horreur Surnaturelle', en: 'Supernatural Horror' },
      { fr: 'Pixel Art', en: 'Pixel Art' },
    ],
    platforms: ['PC'],
  ...
  },
  {
    ...
    genres: [
      { fr: 'FPS Narratif', en: 'Narrative FPS' },
      { fr: 'Immersive Sim', en: 'Immersive Sim' },
      { fr: 'Sci-Fi', en: 'Sci-Fi' },
    ],
    platforms: ['PC', 'PlayStation 5', 'Xbox Series X/S'],
